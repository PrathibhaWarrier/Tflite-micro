...
${TEST_SRCDIR}/${TEST_WORKSPACE}/tensorflow/lite/micro/examples/wav2letter/micro_speech_mock 2>&1 | head > ${OUTPUT_LOG_FILE}
...
echo
echo "SUCCESS: wav2letter_binary_mock_test PASSED"
